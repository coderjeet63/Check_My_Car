  ...
  const handleClick = () => {
    ...
    <div className="flex flex-wrap justify-center">
      <div className="md:w-2/3 xl:w-1/2 p-20 flex flex-col">
        <h4 className="text-blue-500 text-lg font-bold m-4">Best Auto Workshop in Noida | Trusted Car Mechanics</h4>
        <h2 className="text-4xl font-bold  m-4">We Specialize in providing expert car repair services</h2>
        <h3  className="text-gray-500 text-2xl  m-4 ">Welcome to our CheckMyCar Workshop in Noida!</h3>
        <p className="text-lg text-gray-600 m-4">Leading experts with years of expertise, CheckMyCar Workshop has a passion for all things automotive. Due to the state-of-the-art instruments and scanning technology in our workshop, we are able to identify and fix even the most complicated electrical problems. 
